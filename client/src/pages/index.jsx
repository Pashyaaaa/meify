        ...
        <main className="bg-slate-950 py-12 relative overflow-hidden">
          ...
          <div className="relative z-10 text-white text-center font-lato font-serif flex justify-center items-center">
            ...
            <h1 className="text-3xl md:text-5xl font-lato font-extrabold">
              <span className="font-pacifico text-green-500">Me</span>ify
            </h1>
            <div className="animate-bounce text-xl md:text-3xl">🎧</div>
          </div>

          <p className="relative z-10 text-white text-xs text-center font-motserrat">
            ...
            <ul className="p-2 font-montserrat">
              ...
              <li className="mb-8">
                ...
                <ul>
                  ...
                  <Hyperlink to="https://instagram.com/vyanzll" target="_blank">
